...
2- Copiar y descomprimir el archivo en la carpeta c:\xampp\htdocs, al final tendras una carpeta llamada “simple_invoice”, a la cual podras acceder desde el navegador como: http://localhost/facturacion-project/
...
6- Vista web: http://localhost/facturacion-project/
